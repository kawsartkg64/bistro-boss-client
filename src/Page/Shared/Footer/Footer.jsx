...
const Footer = () => {
    return (
        <footer>
            <div className="footer p-6 md:p-10 bg-neutral text-neutral-content">
                <aside className='flex flex-col items-center md:flex-row md:justify-between'>
            ...
            <div className=''>
                <div className="footer  items-center  p-4 bg-neutral justify-center text-neutral-content">
