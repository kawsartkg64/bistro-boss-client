...
const COLORS = ['#0088FE', '#00C49F', '#FFBB28', '#FF8042','#633974'];
            ...
            <div>
                <div className="stats shadow">
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-value">{stat?.user}</div>
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-value">{stat?.menuItem}</div>
                    ...
                    <div className="stat">
                        ...
                        <div className="stat-value">{stat?.order}</div>
                        <div className="stat-desc">↘︎ 90 (14%)</div>
                    </div>
